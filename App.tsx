               ...
               <div className="mb-12">
                 ...
                 <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                   ...
                   >
                     ...
                     <span className="font-black text-slate-700">White</span>
                   </button>
                   ...
                   >
                     <div className="w-6 h-6 rounded-full border border-slate-300 bg-[#2196F3] shadow-inner"></div>
                     <span className="font-black text-slate-700">Blue</span>
                   </button>
